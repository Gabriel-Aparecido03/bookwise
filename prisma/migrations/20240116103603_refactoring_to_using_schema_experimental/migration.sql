...
INSERT INTO "new_Account" ("expires_at", "id", "id_token", "provider", "providerAccountId", "scope", "session_state", "token_type", "type", "userId") SELECT "expires_at", "id", "id_token", "provider", "providerAccountId", "scope", "session_state", "token_type", "type", "userId" FROM "Account";
DROP TABLE "Account";
