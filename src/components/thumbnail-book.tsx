...
export function ThumbnailBook({ author, coverUrl, id, name, rate }: ThumbnailBookType) {
  ...
  return (
    <>
      ...
      <div id="thumbnail-book"  onClick={() =>{ setOpenDrawer(true)} } className="rounded-lg w-[20rem] h-[8rem] bg-gray-700 p-4 flex cursor-pointer items-stretch justify-start gap-5 border-2 border-solid border-transparent hover:border-gray-600 transition-all duration-75">
